...
#   IMAGE_TAG=<tag>
#   BACKOFFICE_DOMAIN=supervisor.62.238.27.201.nip.io
#   PUBLIC_DOMAIN=hello.62.238.27.201.nip.io
#   HELLO_VERSION=v1
...
BACKOFFICE_DOMAIN="${BACKOFFICE_DOMAIN:-supervisor.62.238.27.201.nip.io}"
PUBLIC_DOMAIN="${PUBLIC_DOMAIN:-hello.62.238.27.201.nip.io}"
...
sed \
  ...
  -e "s|backoffice: supervisor.62.238.27.201.nip.io|backoffice: $BACKOFFICE_DOMAIN|g" \
  -e "s|public: hello.62.238.27.201.nip.io|public: $PUBLIC_DOMAIN|g" \
