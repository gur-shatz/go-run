...
| Backoffice/control | `https://supervisor.203.0.113.10.nip.io/backoffice/...` | Supervisor health, state, summary, metrics, component info, logs |
| Public app | `https://hello.203.0.113.10.nip.io/...` | User-facing hello component running as a supervisor child |

Both domains are currently restricted to the operator IP `198.51.100.10/32`.
...
- `https://hello.203.0.113.10.nip.io/greet`
  - returns `Hello from supervisor on hertzner1`
- `https://hello.203.0.113.10.nip.io/healthz`
  - returns `ok`
- `https://supervisor.203.0.113.10.nip.io/backoffice/healthz`
  - returns `ok`
- `https://supervisor.203.0.113.10.nip.io/backoffice/summary`
...
| Middleware | `supervisor-ip-allowlist`, `sourceRange: ["198.51.100.10/32"]` |
